...
class Cli {
    ...
    createTruck() {
        inquirer
            ...
            // TODO: The generateVin method is static and should be called using the class name Cli, make sure to use Cli.generateVin() for creating a truck and motorbike as well!
            Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), new Array(4).fill(null).map(() => new Wheel()), parseInt(answers.towingCapacity));
    ...
    // method to select or create another vehicle
    selectOrCreate() {
        inquirer
            .prompt([
            {
                type: 'list',
                name: 'action',
                message: 'Select or create another vehicle',
                choices: [
                    'Select a vehicle',
            ...
            .then((answers) => {
            if (answers.action === 'Select a vehicle') {
                this.chooseVehicle();
            }
